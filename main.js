...
// (The bot-config cloud-sync proxies were removed with the in-app bot: the
// bot now runs cloud-side as the Aquilo Bot, configured on aquilo.gg/bot.
// The worker's /bot-config endpoint stays up so old exports remain readable.)
